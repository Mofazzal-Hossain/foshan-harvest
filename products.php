    ...
    <div class="product-list-content center">
            ...
            <li class="product-item">
                <a href="single-product.php">
                    ...
                    <div class="ct">
                        ...
                        <h6>The main washing area has a high power of 12kw, providing sufficient high-temperature hot water to
                            dissolve heavy oil and dirt in the main washing water tank, and efficiently cleaning with high power
                        </h6>
                    </div>
                </a>
            </li>
            ...
            <li class="product-item">
                <a href="single-product.php">
                    ...
                    <div class="ct">
                        ...
                        <h6>Applicable place：Medium or large hotels/restaurant, guest house, chain restaurants, canteen</h6>
                    </div>
                </a>
            </li>
        </ul>
        ...
        <div class="product-list-pagination" data-aos="fade-up">
            <div class="el-pagination">
                <button type="button" disabled="disabled" class="btn-prev">first
                ...
                <button type="button" class="btn-next">last
