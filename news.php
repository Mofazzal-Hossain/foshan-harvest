...
<div class="breadcrumb-wrapper bg-white">
    <div class="breadcrumb-inner center" data-aos="fade-up">
        ...
        <div class="right">
            <a href="news.php" class="active">Industry News</a>
        ...
        <ul class="news-lists" data-aos="fade-up">
            ...
            <li class="news-item">
                <a href="single-news.php">
                    ...
                    <div class="right">
                        <div class="txt">
                            <h3>Leading the Kitchen X8 Dishwasher, Leading a New Era of Kitchen Cleaning with Minimalist
                                Aesthetics</h3>
                            <h6>In today's society, with the acceleration of the pace of life and the improvement of public
                                aesthetics, the minimalist aesthetics of less is more and simplifying complexity has become one of
                                the new consumer trends. More and more consumers not only consid</h6>
                        </div>
                        <img src="assets/images/news-img-2.jpg" alt="news image">
                    </div>
                </a>
            </li>
            <!-- news item -->
                ...
                <a href="single-news.php">
                    ...
                    <div class="right">
                        <div class="txt">
                            <h3>Leading the Kitchen X8 Dishwasher, Leading a New Era of Kitchen Cleaning with Minimalist
                                Aesthetics</h3>
                            <h6>Leading the Kitchen X8 Dishwasher, Leading a New Era of Kitchen Cleaning with Minimalist
                                Aesthetics</h6>
                        </div>
                        <img src="assets/images/news-img-3.jpg" alt="news image">
                    </div>
                </a>
            </li>
            <!-- news item -->
            <li class="news-item">
                <a href="single-news.php">
                    ...
                    <div class="right">
                        ...
                        <img src="assets/images/news-img-4.jpg" alt="news image">
                    </div>
                </a>
            </li>
        </ul>
